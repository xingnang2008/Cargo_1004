                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="bootstrap-admin-panel-content">
                                    <table class="table bootstrap-admin-table-with-actions">
                                        ...
                                        <tbody>
										<s:iterator value="drivers" var="d">
                                            <tr>
                                                <td><s:property value="#d.id"/></td>
                                                <td><s:property value="#d.signNo"/> </td>
                                                <td><s:property value="#d.name"/> </td>
                                                <td><s:property value="#d.cardNo"/></td>
                                                <td><s:date name="#d.birthDate" format="yyyy-MM-dd"/></td>
												<td><s:property value="#d.address"/></td>
												<td><s:property value="#d.phone"/></td>
												<td><s:property value="#d.cardType"/> </td>												
                                                <td class="actions">
                                                    <a href="#">
